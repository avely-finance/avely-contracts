...
func Deploy(sdk *AvelySDK, log *Log) *Protocol {
	...
	// deploy azil
	Azil, err := NewAZilContract(sdk, sdk.Cfg.Owner, Zimpl.Addr, sdk.Cfg.SsnAddrs)
	if err != nil {
...
func RestoreFromState(sdk *AvelySDK, log *Log) *Protocol {
	...
	// Restore azil
	Azil, err := RestoreAZilContract(sdk, sdk.Cfg.AzilAddr, sdk.GetAddressFromPrivateKey(sdk.Cfg.OwnerKey), Zimpl.Addr, sdk.Cfg.SsnAddrs)
	if err != nil {
